...
namespace Valve.VR.InteractionSystem
{
	...
	public class ArrowHand : MonoBehaviour
	{
        ...
        private static bool isArrowInAir = false;
        ...
        public static bool GetIsArrowInAir()
        {
            return isArrowInAir;
        }

        public static void SetIsArrowInAir(bool val)
        {
            isArrowInAir = val;
        }
		...
		private void HandAttachedUpdate( Hand hand )
		{
			...
			if ( allowArrowSpawn && ( currentArrow == null ) && !isArrowInAir ) // If we're allowed to have an active arrow in hand but don't yet, spawn one
			{
			...
			if ( !nocked  && !isArrowInAir)
			{
				...
				{
					if ( currentArrow == null && !isArrowInAir)
					{
						currentArrow = InstantiateArrow();
					}

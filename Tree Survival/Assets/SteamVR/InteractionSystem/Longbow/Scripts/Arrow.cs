...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Arrow : MonoBehaviour
    {
        ...
        public delegate void ArrowAction(Arrow me, string collisionName, Transform treeTeleportationTransform);
        public static event ArrowAction OnArrowLanded;
        public static event ArrowAction OnArrowReleased;
        public static bool haveEventsBeenSubscribedTo;
        ...
        void Awake()
        {
            ...
            OnArrowLanded = null;
            OnArrowReleased = null;
            haveEventsBeenSubscribedTo = false;
        }
